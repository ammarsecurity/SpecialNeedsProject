...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Children with special needs registration</title>
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
          ...
          <?php if (Session::get('id') == TRUE) { ?>
            ...
            <?php
      				...
      				$path = $_SERVER['SCRIPT_FILENAME'];
      				$current = basename($path, '.php');
      				if ($current == 'SpecialNeedsRegistration') {
      					echo "active ";
      				}
            ...
            ">
              ...
              <a class="nav-link" href="SpecialNeedsRegistration.php"><i class="fab fa-500px mr-2"></i>Special Needs Registration <span class="sr-only"></span></a>
            </li>
            ...
            ">
              ...
              <a class="nav-link" href="AddSpecialType.php"><i class="fab fa-500px mr-2"></i>Add Special Type<span class="sr-only"></span></a>
            </li>
